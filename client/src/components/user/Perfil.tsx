...
const Perfil = () => {
  ...
  return (
    <div className=" bg-white h-[100vh] justify-center bg-no-repeat ">
      <div className="z-10 w-[100vw] h-[30vh] bg-[#222222] flex justify-center items-center">
    ...
    <div className=" -mt-40  md:p-10 border bg-white border-black rounded-xl h-full md:mx-40 my-auto">
      ...
      <img className= "border border-black rounded-xl w-1/2 justify-self-center" src={img} alt="user pic" />
      ...
      <div className="border border-black rounded-xl w-full justify-self-center p-5">
        <h1 className=" text-center font-bold text-lg">DATOS DE LA CUENTA</h1>
        <div className="w-5/6  justify-items-stretch">
        <div className=" flex mt-5">
        <label className="rounded-lg bg-red-100 mr-5 w-1/2 text-left p-1" >{user.name}</label> 
        <label className="rounded-lg bg-red-100 w-1/2 text-left p-1" >{user.lastname}</label>
       </div>
       <div className="mt-4">
       <label className="rounded-lg bg-red-100 w-2/3 text-left p-1">{user.email} </label>
       </div>

       <div className="mt-4 mb-10">
       <label className="rounded-lg bg-red-100 w-2/3 text-left p-1 ">Tel. {user.phone_number} </label>
       </div>
