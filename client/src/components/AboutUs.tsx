    ...
    <div className="bg-white  block bg-bg-prods pt-80 h-screen  mb-10">
      <div className="bg-white block bg-no-repeat align-bottom h-screen border-t-2 border-black pt-10 ">
        <div className="flex flex-col-2 pt-10 h-full">
          <div className="w-2/3  px-28 mt-4 items-center">
            ...
            <p className="font-display text-xl m-10">
          ...
          <div className="flex m-4 w-1/3">
            <img
              src="https://images.unsplash.com/photo-1567894340315-735d7c361db0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=437&q=80"
              alt="Barbero"
              className="h-5/6"
            />
          </div>
      ...
      <div className="bg-white block bg-no-repeat align-bottom h-screen pt-10 ">
        ...
        <div className="flex justify-center flex-col-3">
          <img
            className="h-60 flex mx-5"
            src="https://www.theshaveclub.es/wp-content/uploads/2022/02/IMG_1452-2-scaled.jpg"
            alt="barber1"
          />
          <img
            className="h-60 flex mx-20"
            src="https://www.baronsbarbershop.com/wp-content/uploads/2020/02/vistares_3_1200x800.jpg"
            alt="barber2"
          />
          <img
            className="h-60  flex mx-5"
            src="https://cdn.shopify.com/s/files/1/0606/1157/files/1_7_grande.jpg?6443"
            alt="barber3"
          />
        </div>
      </div>
