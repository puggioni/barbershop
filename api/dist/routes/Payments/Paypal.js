...
router.post("/create-order", checkStock_1.checkStock, (req, res) =>
    ...
    try {
      const order = {
        ...
        application_context: {
          ...
          user_action: "PAY_NOW",
          return_url:
            "https://barbershop-roan.vercel.app/payments/capture-order",
          cancel_url:
            "https://barbershop-roan.vercel.app/payments/cancel-order",
        },
      };
